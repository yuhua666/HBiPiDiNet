...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, 
        ...
        self.fc1 = BiConv(in_features, hidden_features, 1)
        self.act = act_layer()
        #self.fc2 = nn.Conv2d(hidden_features, out_features, 1)
        self.fc2 = BiConv(hidden_features, out_features, 1)
...
@register_model
def bipoolformer_s12(pretrained=False, **kwargs):
    """
...
if has_mmdet:
    ...
    class bipoolformer_s12_feat(PoolFormer):
        """
        PoolFormer-S12 model, Params: 12M
        """
