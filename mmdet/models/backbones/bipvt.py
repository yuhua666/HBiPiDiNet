...
class Mlp(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        self.fc1 = QuantizeLinear(in_features, hidden_features, clip_val=2.5,
        ...
        self.fc2 = QuantizeLinear(hidden_features, out_features, clip_val=2.5,
                                    weight_bits=1, input_bits=1,
                                    weight_layerwise=True, input_layerwise=True,
                                    weight_quant_method='bwn',
                                    input_quant_method='elastic',
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., sr_ratio=1):
        ...
        self.q = QuantizeLinear(dim, dim, clip_val=2.5,
                                    weight_bits=1, input_bits=1,
                                    weight_layerwise=True, input_layerwise=True,
                                    weight_quant_method='bwn',
                                    input_quant_method='elastic',
        ...
        self.kv = QuantizeLinear(dim, dim * 2, clip_val=2.5,
                                    weight_bits=1, input_bits=1,
                                    weight_layerwise=True, input_layerwise=True,
                                    weight_quant_method='bwn',
                                    input_quant_method='elastic',
        ...
        self.proj = QuantizeLinear(dim, dim, clip_val=2.5,
                                    weight_bits=1, input_bits=1,
                                    weight_layerwise=True, input_layerwise=True,
                                    weight_quant_method='bwn',
                                    input_quant_method='elastic',
        ...
        if sr_ratio > 1:
            ...
            self.sr = BinarizeConv2d(dim, dim, kernel_size=sr_ratio, stride=sr_ratio)
...
class bipvt_tiny(PyramidVisionTransformer):
    def __init__(self, **kwargs):
        super(bipvt_tiny, self).__init__(
