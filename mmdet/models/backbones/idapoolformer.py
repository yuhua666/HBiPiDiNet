...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, 
        ...
        #self.fc1 = BinarizeConv2d(in_features, hidden_features, 1)
        ...
        #self.fc2 = BinarizeConv2d(hidden_features, out_features, 1)
...
class PoolFormerBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        # 可视化特征图
        '''feature_map = x #压缩成torch.Size([64, 55, 55])
        print("shape:")
        ...
        cnt = cnt + 1
        print(cnt)
        plt.savefig(str(cnt)+"bipool.png")'''
        return x
...
@register_model
def idapoolformer_s12(pretrained=False, **kwargs):
    """
...
if has_mmdet:
    ...
    class idapoolformer_s12_feat(PoolFormer):
        """
        PoolFormer-S12 model, Params: 12M
        """
